...
public class MVCConf implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/edmin/**").addResourceLocations("classpath:/META-INF/edmin/");
		...
		registry.addResourceHandler("/file/upload/**").addResourceLocations("file:C:/Users/admin/Documents/eclipse/upload/");
	}
}
